...
try {
  ...
  if (!fs.existsSync(LOCAL_DB_PATH)) {
    console.log('⚠️  Local database not found. Creating comprehensive database from scratch...');
    
    // Create database from scratch with all units
    ...
    // Insert comprehensive units data
    insertComprehensiveUnits(db);
    
    db.close();
    console.log('✅ Comprehensive database created successfully');
    return;
  }
...
/**
 * Insert comprehensive units data into the database
 */
async function insertComprehensiveUnits(db) {
  console.log('🌱 Inserting comprehensive units data...');
  ...
  console.log(`✅ Inserted ${insertedCount} units successfully`);
}
